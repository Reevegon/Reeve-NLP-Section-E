...
@st.cache_resource
def load_classifier():
    tokenizer = DistilBertTokenizerFast.from_pretrained("./bert_classifier_model", local_files_only=True)
    model = DistilBertForSequenceClassification.from_pretrained("./bert_classifier_model", local_files_only=True)
